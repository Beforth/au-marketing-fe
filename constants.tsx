...
export const SIDEBAR_LINKS: NavItem[] = [
  ...
  { title: 'Events', icon: CalendarDays, href: '/events', permission: 'marketing.view_events' },
...
// Indian states and union territories (for address state dropdown)
...
// Industry options for organizations
export const INDUSTRY_OPTIONS: { value: string; label: string }[] = [
  { value: 'end user', label: 'End User' },
  { value: 'distributor/dealer', label: 'Distributor / Dealer' },
