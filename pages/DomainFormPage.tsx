...
const loadDomain = async () => {
  ...
  try {
    ...
    if (domain.coordinator_employee_id) {
      coordinatorUsernameMapRef.current.set(domain.coordinator_employee_id, domain.coordinator_username || '');
      if (domain.coordinator_email) coordinatorEmailMapRef.current.set(domain.coordinator_employee_id, domain.coordinator_email);
    }
    setFormData({
      name: domain.name,
      code: domain.code,
      ...
      coordinator_employee_id: domain.coordinator_employee_id,
      coordinator_username: domain.coordinator_username,
      coordinator_email: domain.coordinator_email,
    });
  } catch (error: any) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <AsyncSelect
            ...
            placeholder="Select domain coordinator (optional)"
            initialOptions={
